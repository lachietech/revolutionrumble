            ...
            return `
                <div class="tournament-item">
                    <div class="tournament-info">
                        <h4>${t.name}</h4>
                        <p>${date} • ${t.location} • <span class="status-badge ${statusClass}">${t.status}</span></p>
                    ...
                    ${registrations.map(r => {
                        ...
                        <tr style="border-bottom:1px solid rgba(255,255,255,.03)">
                            <td style="padding:10px 8px">
                                ...
                                ${r.gender ? `<span style="font-size:.75rem;padding:2px 6px;background:${r.gender === 'female' ? 'rgba(236, 72, 153, .2)' : 'rgba(59, 130, 246, .2)'};color:${r.gender === 'female' ? '#ec4899' : '#3b82f6'};border-radius:4px;margin-left:6px">${r.gender === 'female' ? '♀ F' : '♂ M'}</span>` : ''}
